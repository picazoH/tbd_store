module Spree
  ...
  module ProductFilters
    ...
    def ProductFilters.price_filter
      ...
      conds = [ [ I18n.t(:under_price, :price => format_price(5))   , v[:amount].lteq(5)],
                [ "#{format_price(10)} - #{format_price(15)}"        , v[:amount].in(10..15)],
                [ "#{format_price(15)} - #{format_price(18)}"        , v[:amount].in(15..18)],
                [ "#{format_price(18)} - #{format_price(30)}"        , v[:amount].in(18..30)],
                [ I18n.t(:or_over_price, :price => format_price(40)) , v[:amount].gteq(40)]]
